...
public final class CipherSuite {
    ...
    public static final class Companion {
        ...
        private final String secondaryName(String str) {
            boolean y5;
            boolean y6;
            y5 = w.y(str, "TLS_", false, 2, null);
            if (y5) {
                String substring = str.substring(4);
                l.c(substring, "this as java.lang.String).substring(startIndex)");
                return l.i("SSL_", substring);
            }
            y6 = w.y(str, "SSL_", false, 2, null);
            if (y6) {
                String substring2 = str.substring(4);
                l.c(substring2, "this as java.lang.String).substring(startIndex)");
                return l.i("TLS_", substring2);
            }
            return str;
        }
    ...
    static {
        ...
        ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            ...
            public int compare(String str, String str2) {
                ...
                for (int i6 = 4; i6 < min; i6++) {
                    ...
                    if (charAt != charAt2) {
                        return l.e(charAt, charAt2) < 0 ? -1 : 1;
                    }
                }
        ...
        TLS_DHE_RSA_WITH_AES_128_CBC_SHA256 = companion.init("TLS_DHE_RSA_WITH_AES_128_CBC_SHA256", androidx.constraintlayout.widget.g.V0);
        TLS_DHE_DSS_WITH_AES_256_CBC_SHA256 = companion.init("TLS_DHE_DSS_WITH_AES_256_CBC_SHA256", androidx.constraintlayout.widget.g.X0);
        TLS_DHE_RSA_WITH_AES_256_CBC_SHA256 = companion.init("TLS_DHE_RSA_WITH_AES_256_CBC_SHA256", androidx.constraintlayout.widget.g.Y0);
        TLS_DH_anon_WITH_AES_128_CBC_SHA256 = companion.init("TLS_DH_anon_WITH_AES_128_CBC_SHA256", androidx.constraintlayout.widget.g.Z0);
    ...
    public final String m51deprecated_javaName() {
