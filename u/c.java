...
public abstract class c {
    ...
    private static final Object f13403a = new Object();
    ...
    public static Object f(Context context, Class cls) {
        ...
        String g6 = g(context, cls);
        if (g6 != null) {
            return context.getSystemService(g6);
        }
        return null;
    }
    ...
    public static String g(Context context, Class cls) {
        ...
        return (String) a.f13404a.get(cls);
    }
